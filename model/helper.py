...
def generate_noise_edge(edge_index, edge_type, num_ent, num_rel, noise_aggre, all_noise, data_dir, data_name):
    ...
    print('path: ', data_name,
          os.path.join(data_dir, data_name, 'noise', 'random_edge_noise_' + str(noise_aggre) + '.txt'))
...
def construct_adj(data, num_ent, num_rel, noise_aggre, all_noise, data_dir, data_name):
    ...
    if noise_aggre > 0:
        ...
        edge_index, edge_type = generate_noise_edge(edge_index, edge_type, num_ent, num_rel, noise_aggre, all_noise,
                                                    data_dir, data_name)
